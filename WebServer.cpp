...
void WifiController::pageSetupWiFi(AsyncWebServerRequest *request) {
...
void WifiController::pageScanWiFi(AsyncWebServerRequest *request) {
  String response_message = "";
...
void WifiController::pageConnectWiFi(AsyncWebServerRequest *request) {
  String response_message = "";
...
void WifiController::setupNewWIFIcredential(String ssid, String pass) {
  newSSID = ssid;
  newPASS = pass;
